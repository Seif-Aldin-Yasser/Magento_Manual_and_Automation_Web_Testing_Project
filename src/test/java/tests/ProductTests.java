...
public class ProductTests extends BaseTest {
    ...
    public void testInvalidProductSearchWith2Chars() {
        ...
        Assert.assertTrue(searchResultsPage.isMinimumQueryLengthMessageDisplayed(), "Expected 'Minimum Search query length is 3' message not displayed for 2-character search!");
    }
}
